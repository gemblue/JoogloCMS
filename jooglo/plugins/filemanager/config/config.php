...
$upload_dir = 'jooglo/uploads/images/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../uploads/images/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../uploads/images/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
// set the names of file or folder that you want to prevent deletion
$undeletes = array('_users');
