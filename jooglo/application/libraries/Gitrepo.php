...
class GitRepo {
	...
	public function init($repo_path = null, $create_new = false, $_init = true) {
		if (is_string($repo_path)) {
			$this->set_repo_path($repo_path, $create_new, $_init);
		}
	}
	...
	public function test_git() {
		...
		$pipes = array();
		$resource = proc_open(self::get_bin(), $descriptorspec, $pipes);
	...
	public function run($command) {
		return $this->run_command(self::get_bin()." ".$command);
	}
	...
	/**
	 * Runs a 'git config' setter
	 *
	 * Accept parameter and value
	 * 
	 * @access public
	 * @param string  config parameter i.e. user.name or user.email
	 * @param string  value of config
	 * @return void
	 */
	public function set_config($param, $value) {
		$this->run('config '.$param.' "'.$value.'"');
	}

	/**
	 * Runs a 'git config' getter
	 *
	 * Accept parameter
	 * 
	 * @access public
	 ...
	 * @return string value
	 */
	public function get_config($param = '--list') {
		return $this->run('config '.$param);
	}
	 ...
	 * @return  string
	 */
	public function clone_remote($repo_path, $remote) {
		return self::create_new($repo_path, $remote, true);
	}
