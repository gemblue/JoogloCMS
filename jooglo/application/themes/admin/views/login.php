...
<head>
	...
	body {
		...
		background:url(<?php echo base_url('jooglo/application/themes/admin/assets/img/wavegrid.png'); ?>) repeat;
	}
	.container {
		width:500px;
		margin:auto;
...
<div class="container" align="center">
	<div class="logo">
		<a href="<?php echo base_url(); ?>"><?php echo (!empty($logo_form_admin) ? '<img width="200" src="'.base_url($logo_form_admin).'">' : 'Logo'); ?></a>
	</div>
	...
	<div class="login-box">
		...
		<form id="form-login-area" method="POST" action="<?php echo site_url('cms/admin_auth/login'); ?>">
