<div class="row-fluid">
	...
	<div class="container">
		...
		<div><a href="#" class="btn btn-primary btn-nyankod">Menemukan <?php echo $total?> hasil.</a></div>
		
		<div class="margin-md-top item-container">
			<div class="row">
				<?php 
					...
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								{
									?>
									<span class="badge"><a href="#"><?php echo $row_->name?></a></span>
									<?php
								}
								?>
								</div>
