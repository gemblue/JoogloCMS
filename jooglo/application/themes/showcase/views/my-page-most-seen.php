<div class="row-fluid">
	...
	<div class="container">
		<div class="menu-top">
			<div class="row">
				<div class="navbar-left col-md-6 col-xs-12">
					...
					<a class="btn btn-active" href="<?php echo site_url('most-seen')?>" role="button">Most Seen</a>
		...
		<div class="item-container">
			<div class="row">
				<?php 
				$total_post = $this->jooglo->get_most_view_post('product', 'total', 'publish');
				$this->paging->set(9, $total_post, 'most-seen');
				$product = $this->jooglo->get_most_view_post('product', 'array', 'publish', $this->paging->get('limit'), $this->paging->get('limit_order'), 'jooglo_paging_on');
