<div class="row-fluid">
	...
	<div class="container">
		<div class="menu-top">
			<div class="row">
				...
				<div class="navbar-left col-md-6 col-xs-12">
					<a class="btn btn-active" href="<?php echo site_url()?>" role="button">Latest</a>
					<a class="btn btn-nyankod" href="<?php echo site_url('most-seen')?>" role="button">Most Seen</a>
					<a class="btn btn-nyankod" href="<?php echo site_url('most-starred')?>" role="button">Most Starred</a>
				</div>
		...
		<div class="js-masonry" data-masonry-options='{ "itemSelector": ".item" }'>
			...
			<div class="row">
			<?php 
			$total_post = $this->jooglo->get_post('product', 'total', 'publish');
			$this->paging->set(9, $total_post, '');
			$product = $this->jooglo->get_post('product', 'array', 'publish', $this->paging->get('limit'), $this->paging->get('limit_order'), null, null, 'jooglo_paging_on');
			...
			foreach ($product as $row)
			{
				...
				<div class="item">
					<a href="<?php echo site_url($row->post_slug)?>"><img width="70" src="<?php echo $this->jooglo->get_post_thumbnail($row->ID);?>" /></a>
					<div class="caption">
						...
						<p><a href="<?php echo site_url($row->post_slug)?>" class="btn btn-primary" role="button">See Detail</a></p>
					</div>
