<div class="padding-lg-y">
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<h2 class="h3">Daftar Kontributor Devository</h2>
			</div>
			<div class="col-md-4">
		...
		<div class="user-loop margin-lg-top">
			<?php 
			$i = 1;
			foreach ($this->mdl_user->get_list_user('active') as $row)
			{
				?>
				<div class="user-item-wrapper <?php echo ($i % 3 == 0 ? 'no-margin' : ''); ?>">
					<div class="padding-sm">
						<div class="media">
							<a href="<?php echo site_url('~'.$row->username)?>" class="pull-left">
								<img src="<?php echo $this->mdl_user->get_avatar($row->id, 'xs', 'square')?>" width="80" class="img-ava">
							</a>
							<div class="media-body">
								<div class="user-nama"><a href="<?php echo site_url('~'.$row->username)?>" class="link-primary"><?php echo $row->username?></a></div>
